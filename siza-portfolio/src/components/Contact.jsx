    ...
    <section className="contact-section" id="contact" ref={sectionRef}>
      ...
      <div className="contact-links reveal">
        <a href="mailto:sizampafa972@gmail.com" className="contact-link">
          ...
          sizampafa972@gmail.com
        </a>
        <a href="https://github.com/SizaMpafa" target="_blank" className="contact-link" rel="noreferrer">
        ...
        <a href="https://www.linkedin.com/in/sizampafa/" target="_blank" className="contact-link" rel="noreferrer">
          <svg viewBox="0 0 24 24" fill="currentColor">
